...
public class CurrentWorksActivity extends AppCompatActivity implements View.OnClickListener{

    private String result = "";
    private String urlSource = "https://trafficscotland.org/rss/feeds/roadworks.aspx";
    private String inputDate;
    private LinearLayout currentWorksLinearLayout;
    private TextView datePickedView;
    private Button updateCurrentWorks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_works);
        ...
        currentWorksLinearLayout = findViewById(R.id.currentWorksLinearLayout);
        ...
        datePickerListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                updateCurrentWorks.setEnabled(true);
                inputDate = dayString + "/" + month + "/" + year;
                datePickedView.setText(inputDate);
            }
        };

        updateCurrentWorks = findViewById(R.id.displayCurrentWorks);
        updateCurrentWorks.setOnClickListener(this);
        updateCurrentWorks.setEnabled(false);
    }

    public void onClick(View v) {
        // removes previous results before making a call to the API so to avoid duplicates
        currentWorksLinearLayout.removeAllViews();
        startProgress();
    }
    ...
    private class Task implements Runnable{
        ...
        public void run() {
            ...
            CurrentWorksActivity.this.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        CurrentWorksParser parser = new CurrentWorksParser();
                        ArrayList<CurrentWork> currentWorks =
                                parser.processCurrentWorks(result, date, "", true);

                        progressDialog.removeLoadingDialog();

                        parser.displayCurrentWorks(
                                CurrentWorksActivity.this,
                                currentWorks,
                                currentWorksLinearLayout);
                    } catch (IOException e) {
